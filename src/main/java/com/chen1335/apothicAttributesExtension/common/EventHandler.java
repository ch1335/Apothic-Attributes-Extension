...
public class EventHandler {
    ...
    public static void ItemAttributeModifierEvent(ItemAttributeModifierEvent event) {
        ...
        if (registryLookup != null) {
            ...
            if (lureLevel > 0) {
                event.addModifier(ModAttributes.FISHING_SPEED, new AttributeModifier(ApothicAttributesExtension.id("enchantment_lure"), lureLevel * ServerConfig.getFishingSpeedPerLure(), AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND);
            }
